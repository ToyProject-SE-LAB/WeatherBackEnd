...
public class MidTempApi {
	public List<MidTempInfo> midTempData(String apiUrl) throws IOException {
...
//			String baseDate = currentDate.format(DateTimeFormatter.ofPattern("yyyyMMdd"));
            ...
            urlBuilder.append("&" + URLEncoder.encode("tmFc","UTF-8") + "=" + URLEncoder.encode("202408071800", "UTF-8")); /*-일 2회(06:00,18:00)회 생성 되며 발표시각을 입력- YYYYMMDD0600(1800) 최근 24시간 자료만 제공*/
            ...
            // VO 객체 출력
            for (MidTempInfo tempInfo : tempList) {
